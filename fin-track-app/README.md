...
- **Registration & Demo Login:** Users can register a new account or use a demo account for quick access to the app.
...
Use the built-in demo account for quick testing:
...
4. Register a new account or sign in using the demo credentials listed above.

## Project Notes

This application is intentionally built as a front-end, client-side project and simulates authentication through LocalStorage rather than a real backend system. The achieved scopes are: demonstrating dynamic DOM manipulation, interactivity, state persistence, and API consumption using JavaScript.
